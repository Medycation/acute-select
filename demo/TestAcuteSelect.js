...
(function() {
    angular
        .module("acuteSelectTest", ["acute.select"])
        .controller("MainCtrl", MainCtrl);

    MainCtrl.$inject = ['$scope', '$http', '$filter', '$window', '$timeout', 'safeApply'];

    function MainCtrl($scope, $http, $filter, $window, $timeout, safeApply) {
