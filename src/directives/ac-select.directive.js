...
(function () {
    ...
    acSelect.$inject = ['$parse', 'acuteSelectService'];
    function acSelect($parse, acuteSelectService) {
    ...
    acSelectController.$inject = ['$scope', '$element', '$window', '$rootScope', '$timeout', '$filter', 'navKey', 'safeApply'];
    function acSelectController($scope, $element, $window, $rootScope, $timeout, $filter, navKey, safeApply) {
